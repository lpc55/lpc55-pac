...
impl DONER {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            DONER::NO_INTERRUPT => false,
            DONER::INTERRUPT => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> DONER {
        match value {
            false => DONER::NO_INTERRUPT,
            true => DONER::INTERRUPT,
        }
    }
    #[doc = "Checks if the value of the field is `NO_INTERRUPT`"]
    #[inline]
    pub fn is_no_interrupt(&self) -> bool {
        *self == DONER::NO_INTERRUPT
    }
    #[doc = "Checks if the value of the field is `INTERRUPT`"]
    #[inline]
    pub fn is_interrupt(&self) -> bool {
        *self == DONER::INTERRUPT
    }
}
...
impl DONEW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            DONEW::NO_INTERRUPT => false,
            DONEW::INTERRUPT => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _DONEW<'a> {
    ...
    pub fn no_interrupt(self) -> &'a mut W {
        self.variant(DONEW::NO_INTERRUPT)
    }
    #[doc = "Interrupt when done"]
    #[inline]
    pub fn interrupt(self) -> &'a mut W {
        self.variant(DONEW::INTERRUPT)
    }
