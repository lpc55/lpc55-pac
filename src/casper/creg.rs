#[doc = "Reader of register CREG"]
pub type R = crate::R<u32, super::CREG>;
#[doc = "Writer for register CREG"]
pub type W = crate::W<u32, super::CREG>;
#[doc = "Register CREG `reset()`'s with value 0"]
impl crate::ResetValue for super::CREG {
    type Type = u32;
    #[inline(always)]
