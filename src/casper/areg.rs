#[doc = "Reader of register AREG"]
pub type R = crate::R<u32, super::AREG>;
#[doc = "Writer for register AREG"]
pub type W = crate::W<u32, super::AREG>;
#[doc = "Register AREG `reset()`'s with value 0"]
impl crate::ResetValue for super::AREG {
    type Type = u32;
    #[inline(always)]
