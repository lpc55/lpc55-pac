#[doc = "Reader of register DREG"]
pub type R = crate::R<u32, super::DREG>;
#[doc = "Writer for register DREG"]
pub type W = crate::W<u32, super::DREG>;
#[doc = "Register DREG `reset()`'s with value 0"]
impl crate::ResetValue for super::DREG {
    type Type = u32;
    #[inline(always)]
