...
#[doc = r" Value of the field"]
pub struct FORCE_SOFT_RESETR {
    bits: bool,
}
impl FORCE_SOFT_RESETR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Proxy"]
pub struct _FORCE_SOFT_RESETW<'a> {
    w: &'a mut W,
}
impl<'a> _FORCE_SOFT_RESETW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn force_soft_reset(&self) -> FORCE_SOFT_RESETR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        FORCE_SOFT_RESETR { bits }
    }
...
impl W {
    ...
    #[doc = "Bit 1 - When used with softreset it forces CORE_RESETN to low on acknowledge from CORE."]
    #[inline]
    pub fn force_soft_reset(&mut self) -> _FORCE_SOFT_RESETW {
        _FORCE_SOFT_RESETW { w: self }
    }
    #[doc = "Bit 31 - When set all accesses to standard registers are blocked."]
    #[inline]
