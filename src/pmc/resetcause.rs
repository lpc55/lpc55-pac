#[doc = "Reader of register RESETCAUSE"]
pub type R = crate::R<u32, super::RESETCAUSE>;
#[doc = "Writer for register RESETCAUSE"]
pub type W = crate::W<u32, super::RESETCAUSE>;
#[doc = "Register RESETCAUSE `reset()`'s with value 0x01"]
impl crate::ResetValue for super::RESETCAUSE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn padreset(&self) -> PADRESET_R {
        PADRESET_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    ...
    pub fn bodreset(&self) -> BODRESET_R {
        BODRESET_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    ...
    pub fn systemreset(&self) -> SYSTEMRESET_R {
        SYSTEMRESET_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    ...
    pub fn dpdreset_wakeupio(&self) -> DPDRESET_WAKEUPIO_R {
        DPDRESET_WAKEUPIO_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    ...
    pub fn dpdreset_rtc(&self) -> DPDRESET_RTC_R {
        DPDRESET_RTC_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    ...
    pub fn dpdreset_ostimer(&self) -> DPDRESET_OSTIMER_R {
        DPDRESET_OSTIMER_R::new(((self.bits >> 8) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - 1 : The last chip reset was caused by a Power On Reset. Write '1' to clear this bit."]
