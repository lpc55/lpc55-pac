#[doc = "Reader of register DAP_VENDOR_USAGE_FIXED"]
pub type R = crate::R<u32, super::DAP_VENDOR_USAGE_FIXED>;
#[doc = "Writer for register DAP_VENDOR_USAGE_FIXED"]
pub type W = crate::W<u32, super::DAP_VENDOR_USAGE_FIXED>;
#[doc = "Register DAP_VENDOR_USAGE_FIXED `reset()`'s with value 0"]
impl crate::ResetValue for super::DAP_VENDOR_USAGE_FIXED {
    type Type = u32;
    #[inline(always)]
