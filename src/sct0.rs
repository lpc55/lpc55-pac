...
pub struct RegisterBlock {
    ...
    _reserved_29_cap_match: [u8; 4usize],
    _reserved_30_cap_match: [u8; 4usize],
    _reserved_31_cap_match: [u8; 4usize],
    _reserved_32_cap_match: [u8; 4usize],
    _reserved_33_cap_match: [u8; 4usize],
    _reserved_34_cap_match: [u8; 4usize],
    ...
    _reserved_39_capctrl_matchrel: [u8; 4usize],
    _reserved_40_capctrl_matchrel: [u8; 4usize],
    _reserved_41_capctrl_matchrel: [u8; 4usize],
    _reserved_42_capctrl_matchrel: [u8; 4usize],
    _reserved_43_capctrl_matchrel: [u8; 4usize],
    _reserved_44_capctrl_matchrel: [u8; 4usize],
    _reserved_45_capctrl_matchrel: [u8; 4usize],
    _reserved_46_capctrl_matchrel: [u8; 4usize],
    _reserved_47_capctrl_matchrel: [u8; 4usize],
    _reserved_48_capctrl_matchrel: [u8; 4usize],
    _reserved_49_capctrl_matchrel: [u8; 4usize],
    _reserved_50_capctrl_matchrel: [u8; 4usize],
