...
pub struct R(crate::R<CMDH14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMDH14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CMDH14_SPEC>> for R {
    fn from(reader: crate::R<CMDH14_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMDH14` writer"]
pub struct W(crate::W<CMDH14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMDH14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CMDH14_SPEC>> for W {
    fn from(writer: crate::W<CMDH14_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct CMDH14_SPEC;
impl crate::RegisterSpec for CMDH14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cmdh14::R](R) reader structure"]
impl crate::Readable for CMDH14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cmdh14::W](W) writer structure"]
impl crate::Writable for CMDH14_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CMDH14 to value 0"]
impl crate::Resettable for CMDH14_SPEC {
    #[inline(always)]
