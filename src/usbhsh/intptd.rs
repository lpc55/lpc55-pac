#[doc = "Reader of register INTPTD"]
pub type R = crate::R<u32, super::INTPTD>;
#[doc = "Writer for register INTPTD"]
pub type W = crate::W<u32, super::INTPTD>;
#[doc = "Register INTPTD `reset()`'s with value 0"]
impl crate::ResetValue for super::INTPTD {
    type Type = u32;
    #[inline(always)]
