#[doc = "Reader of register ATLPTD"]
pub type R = crate::R<u32, super::ATLPTD>;
#[doc = "Writer for register ATLPTD"]
pub type W = crate::W<u32, super::ATLPTD>;
#[doc = "Register ATLPTD `reset()`'s with value 0"]
impl crate::ResetValue for super::ATLPTD {
    type Type = u32;
    #[inline(always)]
