#[doc = "Reader of register ATLPTDD"]
pub type R = crate::R<u32, super::ATLPTDD>;
#[doc = "Writer for register ATLPTDD"]
pub type W = crate::W<u32, super::ATLPTDD>;
#[doc = "Register ATLPTDD `reset()`'s with value 0"]
impl crate::ResetValue for super::ATLPTDD {
    type Type = u32;
    #[inline(always)]
