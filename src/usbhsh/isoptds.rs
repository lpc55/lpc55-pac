#[doc = "Reader of register ISOPTDS"]
pub type R = crate::R<u32, super::ISOPTDS>;
#[doc = "Writer for register ISOPTDS"]
pub type W = crate::W<u32, super::ISOPTDS>;
#[doc = "Register ISOPTDS `reset()`'s with value 0"]
impl crate::ResetValue for super::ISOPTDS {
    type Type = u32;
    #[inline(always)]
