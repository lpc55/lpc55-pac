#[doc = "Reader of register ATLPTDS"]
pub type R = crate::R<u32, super::ATLPTDS>;
#[doc = "Writer for register ATLPTDS"]
pub type W = crate::W<u32, super::ATLPTDS>;
#[doc = "Register ATLPTDS `reset()`'s with value 0"]
impl crate::ResetValue for super::ATLPTDS {
    type Type = u32;
    #[inline(always)]
