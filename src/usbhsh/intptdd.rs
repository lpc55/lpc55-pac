#[doc = "Reader of register INTPTDD"]
pub type R = crate::R<u32, super::INTPTDD>;
#[doc = "Writer for register INTPTDD"]
pub type W = crate::W<u32, super::INTPTDD>;
#[doc = "Register INTPTDD `reset()`'s with value 0"]
impl crate::ResetValue for super::INTPTDD {
    type Type = u32;
    #[inline(always)]
