#[doc = "Reader of register ISOPTD"]
pub type R = crate::R<u32, super::ISOPTD>;
#[doc = "Writer for register ISOPTD"]
pub type W = crate::W<u32, super::ISOPTD>;
#[doc = "Register ISOPTD `reset()`'s with value 0"]
impl crate::ResetValue for super::ISOPTD {
    type Type = u32;
    #[inline(always)]
