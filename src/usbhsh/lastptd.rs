#[doc = "Reader of register LASTPTD"]
pub type R = crate::R<u32, super::LASTPTD>;
#[doc = "Writer for register LASTPTD"]
pub type W = crate::W<u32, super::LASTPTD>;
#[doc = "Register LASTPTD `reset()`'s with value 0"]
impl crate::ResetValue for super::LASTPTD {
    type Type = u32;
    #[inline(always)]
