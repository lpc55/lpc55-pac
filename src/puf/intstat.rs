...
#[doc = r" Proxy"]
pub struct _KEYOUTAVAILW<'a> {
    w: &'a mut W,
}
impl<'a> _KEYOUTAVAILW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _CODEINREQW<'a> {
    w: &'a mut W,
}
impl<'a> _CODEINREQW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _CODEOUTAVAILW<'a> {
    w: &'a mut W,
}
impl<'a> _CODEOUTAVAILW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 1 - Level sensitive interrupt, cleared when interrupt source clears"]
    #[inline]
    pub fn success(&mut self) -> _SUCCESSW {
        _SUCCESSW { w: self }
    }
    #[doc = "Bit 2 - Level sensitive interrupt, cleared when interrupt source clears"]
    #[inline]
    ...
    #[doc = "Bit 4 - Level sensitive interrupt, cleared when interrupt source clears"]
    #[inline]
    pub fn keyinreq(&mut self) -> _KEYINREQW {
        _KEYINREQW { w: self }
    }
    #[doc = "Bit 5 - Level sensitive interrupt, cleared when interrupt source clears"]
    #[inline]
    pub fn keyoutavail(&mut self) -> _KEYOUTAVAILW {
        _KEYOUTAVAILW { w: self }
    }
    #[doc = "Bit 6 - Level sensitive interrupt, cleared when interrupt source clears"]
    #[inline]
    pub fn codeinreq(&mut self) -> _CODEINREQW {
        _CODEINREQW { w: self }
    }
    #[doc = "Bit 7 - Level sensitive interrupt, cleared when interrupt source clears"]
    #[inline]
    pub fn codeoutavail(&mut self) -> _CODEOUTAVAILW {
        _CODEOUTAVAILW { w: self }
    }
}
