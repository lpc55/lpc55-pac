...
#[doc = r" Proxy"]
pub struct _GENERATEKEYW<'a> {
    w: &'a mut W,
}
impl<'a> _GENERATEKEYW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 0 - Begin Zeroize operation for PUF and go to Error state"]
    #[inline]
    pub fn zeroize(&mut self) -> _ZEROIZEW {
        _ZEROIZEW { w: self }
    }
    #[doc = "Bit 1 - Begin Enroll operation"]
    #[inline]
    pub fn enroll(&mut self) -> _ENROLLW {
        _ENROLLW { w: self }
    }
    #[doc = "Bit 2 - Begin Start operation"]
    #[inline]
    ...
    #[doc = "Bit 3 - Begin Set Intrinsic Key operation"]
    #[inline]
    pub fn generatekey(&mut self) -> _GENERATEKEYW {
        _GENERATEKEYW { w: self }
    }
    #[doc = "Bit 4 - Begin Set User Key operation"]
    #[inline]
    pub fn setkey(&mut self) -> _SETKEYW {
        _SETKEYW { w: self }
    }
    #[doc = "Bit 6 - Begin Get Key operation"]
    #[inline]
    pub fn getkey(&mut self) -> _GETKEYW {
        _GETKEYW { w: self }
    }
}
