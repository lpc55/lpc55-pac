#[doc = "Reader of register MISC_CTRL_DP_REG"]
pub type R = crate::R<u32, super::MISC_CTRL_DP_REG>;
#[doc = "Writer for register MISC_CTRL_DP_REG"]
pub type W = crate::W<u32, super::MISC_CTRL_DP_REG>;
#[doc = "Register MISC_CTRL_DP_REG `reset()`'s with value 0xaaaa"]
impl crate::ResetValue for super::MISC_CTRL_DP_REG {
    type Type = u32;
    #[inline(always)]
