...
impl From<USBFSD_A> for u8 {
    ...
    fn from(variant: USBFSD_A) -> Self {
        match variant {
            USBFSD_A::ENUM_S_P => 0,
            USBFSD_A::ENUM_S_NP => 1,
            USBFSD_A::ENUM_NS_P => 2,
            USBFSD_A::ENUM_NS_NP => 3,
        }
    }
}
...
impl From<USBFSH_A> for u8 {
    ...
    fn from(variant: USBFSH_A) -> Self {
        match variant {
            USBFSH_A::ENUM_S_P => 0,
            USBFSH_A::ENUM_S_NP => 1,
            USBFSH_A::ENUM_NS_P => 2,
            USBFSH_A::ENUM_NS_NP => 3,
        }
    }
}
...
impl From<MASTER_SEC_LEVEL_ANTIPOL_LOCK_A> for u8 {
    ...
    fn from(variant: MASTER_SEC_LEVEL_ANTIPOL_LOCK_A) -> Self {
        match variant {
            MASTER_SEC_LEVEL_ANTIPOL_LOCK_A::BLOCKED => 1,
            MASTER_SEC_LEVEL_ANTIPOL_LOCK_A::WRITABLE => 2,
        }
    }
}
