...
#[doc = r" Value of the field"]
pub struct MASTER_SEC_LEVEL_ANTIPOL_LOCKR {
    bits: u8,
}
...
impl R {
    ...
    #[doc = "Bits 12:13 - EZH Data. Must be equal to NOT(MASTER_SEC_LEVEL.EZH_D)"]
    #[inline]
    ...
    #[doc = "Bits 14:15 - EZH instruction. Must be equal to NOT(MASTER_SEC_LEVEL.EZH_I)"]
    #[inline]
    ...
    #[doc = "Bits 30:31 - master_sec_antipol_reg register write-lock. When 2'b10, this register can be written. With any other value, this register can't be written."]
    #[inline]
    pub fn master_sec_level_antipol_lock(&self) -> MASTER_SEC_LEVEL_ANTIPOL_LOCKR {
        ...
        MASTER_SEC_LEVEL_ANTIPOL_LOCKR { bits }
    }
}
impl W {
