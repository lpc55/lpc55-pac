...
#[doc = "Possible values of the field `PVTVF0_AMBER_IRQ`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PVTVF0_AMBER_IRQR {
    #[doc = "no description available"]
    INVISIBLE,
    #[doc = "no description available"]
    VISIBLE,
}
impl PVTVF0_AMBER_IRQR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
        !self.bit()
    ...
    pub fn bit(&self) -> bool {
        match *self {
            PVTVF0_AMBER_IRQR::INVISIBLE => false,
            PVTVF0_AMBER_IRQR::VISIBLE => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> PVTVF0_AMBER_IRQR {
        match value {
            false => PVTVF0_AMBER_IRQR::INVISIBLE,
            true => PVTVF0_AMBER_IRQR::VISIBLE,
        }
    }
    #[doc = "Checks if the value of the field is `INVISIBLE`"]
    #[inline]
    pub fn is_invisible(&self) -> bool {
        *self == PVTVF0_AMBER_IRQR::INVISIBLE
    }
    #[doc = "Checks if the value of the field is `VISIBLE`"]
    #[inline]
    pub fn is_visible(&self) -> bool {
        *self == PVTVF0_AMBER_IRQR::VISIBLE
    }
}
#[doc = "Possible values of the field `PVTVF0_RED_IRQ`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PVTVF0_RED_IRQR {
    #[doc = "no description available"]
    INVISIBLE,
    #[doc = "no description available"]
    VISIBLE,
}
impl PVTVF0_RED_IRQR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
        !self.bit()
    ...
    pub fn bit(&self) -> bool {
        match *self {
            PVTVF0_RED_IRQR::INVISIBLE => false,
            PVTVF0_RED_IRQR::VISIBLE => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> PVTVF0_RED_IRQR {
        match value {
            false => PVTVF0_RED_IRQR::INVISIBLE,
            true => PVTVF0_RED_IRQR::VISIBLE,
        }
    }
    #[doc = "Checks if the value of the field is `INVISIBLE`"]
    #[inline]
    pub fn is_invisible(&self) -> bool {
        *self == PVTVF0_RED_IRQR::INVISIBLE
    }
    #[doc = "Checks if the value of the field is `VISIBLE`"]
    #[inline]
    pub fn is_visible(&self) -> bool {
        *self == PVTVF0_RED_IRQR::VISIBLE
    }
}
#[doc = "Possible values of the field `PVTVF1_AMBER_IRQ`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PVTVF1_AMBER_IRQR {
    #[doc = "no description available"]
    INVISIBLE,
    #[doc = "no description available"]
    VISIBLE,
}
impl PVTVF1_AMBER_IRQR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
        !self.bit()
    ...
    pub fn bit(&self) -> bool {
        match *self {
            PVTVF1_AMBER_IRQR::INVISIBLE => false,
            PVTVF1_AMBER_IRQR::VISIBLE => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> PVTVF1_AMBER_IRQR {
        match value {
            false => PVTVF1_AMBER_IRQR::INVISIBLE,
            true => PVTVF1_AMBER_IRQR::VISIBLE,
        }
    }
    #[doc = "Checks if the value of the field is `INVISIBLE`"]
    #[inline]
    pub fn is_invisible(&self) -> bool {
        *self == PVTVF1_AMBER_IRQR::INVISIBLE
    }
    #[doc = "Checks if the value of the field is `VISIBLE`"]
    #[inline]
    pub fn is_visible(&self) -> bool {
        *self == PVTVF1_AMBER_IRQR::VISIBLE
    }
}
#[doc = "Possible values of the field `PVTVF1_RED_IRQ`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PVTVF1_RED_IRQR {
    #[doc = "no description available"]
    INVISIBLE,
    #[doc = "no description available"]
    VISIBLE,
}
impl PVTVF1_RED_IRQR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
        !self.bit()
    ...
    pub fn bit(&self) -> bool {
        match *self {
            PVTVF1_RED_IRQR::INVISIBLE => false,
            PVTVF1_RED_IRQR::VISIBLE => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> PVTVF1_RED_IRQR {
        match value {
            false => PVTVF1_RED_IRQR::INVISIBLE,
            true => PVTVF1_RED_IRQR::VISIBLE,
        }
    }
    #[doc = "Checks if the value of the field is `INVISIBLE`"]
    #[inline]
    pub fn is_invisible(&self) -> bool {
        *self == PVTVF1_RED_IRQR::INVISIBLE
    }
    #[doc = "Checks if the value of the field is `VISIBLE`"]
    #[inline]
    pub fn is_visible(&self) -> bool {
        *self == PVTVF1_RED_IRQR::VISIBLE
    }
}
...
#[doc = "Values that can be written to the field `PVTVF0_AMBER_IRQ`"]
pub enum PVTVF0_AMBER_IRQW {
    #[doc = "no description available"]
    INVISIBLE,
    #[doc = "no description available"]
    VISIBLE,
}
impl PVTVF0_AMBER_IRQW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            PVTVF0_AMBER_IRQW::INVISIBLE => false,
            PVTVF0_AMBER_IRQW::VISIBLE => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _PVTVF0_AMBER_IRQW<'a> {
    w: &'a mut W,
}
impl<'a> _PVTVF0_AMBER_IRQW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: PVTVF0_AMBER_IRQW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn invisible(self) -> &'a mut W {
        self.variant(PVTVF0_AMBER_IRQW::INVISIBLE)
    }
    #[doc = "no description available"]
    #[inline]
    pub fn visible(self) -> &'a mut W {
        self.variant(PVTVF0_AMBER_IRQW::VISIBLE)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `PVTVF0_RED_IRQ`"]
pub enum PVTVF0_RED_IRQW {
    #[doc = "no description available"]
    INVISIBLE,
    #[doc = "no description available"]
    VISIBLE,
}
impl PVTVF0_RED_IRQW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            PVTVF0_RED_IRQW::INVISIBLE => false,
            PVTVF0_RED_IRQW::VISIBLE => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _PVTVF0_RED_IRQW<'a> {
    w: &'a mut W,
}
impl<'a> _PVTVF0_RED_IRQW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: PVTVF0_RED_IRQW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn invisible(self) -> &'a mut W {
        self.variant(PVTVF0_RED_IRQW::INVISIBLE)
    }
    #[doc = "no description available"]
    #[inline]
    pub fn visible(self) -> &'a mut W {
        self.variant(PVTVF0_RED_IRQW::VISIBLE)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `PVTVF1_AMBER_IRQ`"]
pub enum PVTVF1_AMBER_IRQW {
    #[doc = "no description available"]
    INVISIBLE,
    #[doc = "no description available"]
    VISIBLE,
}
impl PVTVF1_AMBER_IRQW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            PVTVF1_AMBER_IRQW::INVISIBLE => false,
            PVTVF1_AMBER_IRQW::VISIBLE => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _PVTVF1_AMBER_IRQW<'a> {
    w: &'a mut W,
}
impl<'a> _PVTVF1_AMBER_IRQW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: PVTVF1_AMBER_IRQW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn invisible(self) -> &'a mut W {
        self.variant(PVTVF1_AMBER_IRQW::INVISIBLE)
    }
    #[doc = "no description available"]
    #[inline]
    pub fn visible(self) -> &'a mut W {
        self.variant(PVTVF1_AMBER_IRQW::VISIBLE)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `PVTVF1_RED_IRQ`"]
pub enum PVTVF1_RED_IRQW {
    #[doc = "no description available"]
    INVISIBLE,
    #[doc = "no description available"]
    VISIBLE,
}
impl PVTVF1_RED_IRQW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            PVTVF1_RED_IRQW::INVISIBLE => false,
            PVTVF1_RED_IRQW::VISIBLE => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _PVTVF1_RED_IRQW<'a> {
    w: &'a mut W,
}
impl<'a> _PVTVF1_RED_IRQW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: PVTVF1_RED_IRQW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn invisible(self) -> &'a mut W {
        self.variant(PVTVF1_RED_IRQW::INVISIBLE)
    }
    #[doc = "no description available"]
    #[inline]
    pub fn visible(self) -> &'a mut W {
        self.variant(PVTVF1_RED_IRQW::VISIBLE)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bit 28 - PVT Monitor 0 (Process/Voltage/Temperature) Amber interrupt"]
    #[inline]
    pub fn pvtvf0_amber_irq(&self) -> PVTVF0_AMBER_IRQR {
        PVTVF0_AMBER_IRQR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 28;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        })
    }
    #[doc = "Bit 29 - PVT Monitor 0 (Process/Voltage/Temperature) Red interrupt"]
    #[inline]
    pub fn pvtvf0_red_irq(&self) -> PVTVF0_RED_IRQR {
        PVTVF0_RED_IRQR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 29;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        })
    }
    #[doc = "Bit 30 - PVT Monitor 1 (Process/Voltage/Temperature) Amber interrupt"]
    #[inline]
    pub fn pvtvf1_amber_irq(&self) -> PVTVF1_AMBER_IRQR {
        PVTVF1_AMBER_IRQR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 30;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        })
    }
    #[doc = "Bit 31 - PVT Monitor 1 (Process/Voltage/Temperature) Red interrupt"]
    #[inline]
    pub fn pvtvf1_red_irq(&self) -> PVTVF1_RED_IRQR {
        PVTVF1_RED_IRQR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 31;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        })
...
impl W {
    ...
    #[doc = "Bit 28 - PVT Monitor 0 (Process/Voltage/Temperature) Amber interrupt"]
    #[inline]
    pub fn pvtvf0_amber_irq(&mut self) -> _PVTVF0_AMBER_IRQW {
        _PVTVF0_AMBER_IRQW { w: self }
    }
    #[doc = "Bit 29 - PVT Monitor 0 (Process/Voltage/Temperature) Red interrupt"]
    #[inline]
    pub fn pvtvf0_red_irq(&mut self) -> _PVTVF0_RED_IRQW {
        _PVTVF0_RED_IRQW { w: self }
    }
    #[doc = "Bit 30 - PVT Monitor 1 (Process/Voltage/Temperature) Amber interrupt"]
    #[inline]
    pub fn pvtvf1_amber_irq(&mut self) -> _PVTVF1_AMBER_IRQW {
        _PVTVF1_AMBER_IRQW { w: self }
    }
    #[doc = "Bit 31 - PVT Monitor 1 (Process/Voltage/Temperature) Red interrupt"]
    #[inline]
    pub fn pvtvf1_red_irq(&mut self) -> _PVTVF1_RED_IRQW {
        _PVTVF1_RED_IRQW { w: self }
    }
}
