...
pub struct R(crate::R<SEC_CTRL_RAM3_SLAVE_RULE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SEC_CTRL_RAM3_SLAVE_RULE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<SEC_CTRL_RAM3_SLAVE_RULE_SPEC>> for R {
    fn from(reader: crate::R<SEC_CTRL_RAM3_SLAVE_RULE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SEC_CTRL_RAM3_SLAVE_RULE` writer"]
pub struct W(crate::W<SEC_CTRL_RAM3_SLAVE_RULE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SEC_CTRL_RAM3_SLAVE_RULE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<SEC_CTRL_RAM3_SLAVE_RULE_SPEC>> for W {
    fn from(writer: crate::W<SEC_CTRL_RAM3_SLAVE_RULE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct RAM3_RULE_R(crate::FieldReader<u8, RAM3_RULE_A>);
impl RAM3_RULE_R {
    pub(crate) fn new(bits: u8) -> Self {
        RAM3_RULE_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for RAM3_RULE_R {
    type Target = crate::FieldReader<u8, RAM3_RULE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[doc = "Security access rules for RAM3 slaves.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sec_ctrl_ram3_slave_rule](index.html) module"]
pub struct SEC_CTRL_RAM3_SLAVE_RULE_SPEC;
impl crate::RegisterSpec for SEC_CTRL_RAM3_SLAVE_RULE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sec_ctrl_ram3_slave_rule::R](R) reader structure"]
impl crate::Readable for SEC_CTRL_RAM3_SLAVE_RULE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sec_ctrl_ram3_slave_rule::W](W) writer structure"]
impl crate::Writable for SEC_CTRL_RAM3_SLAVE_RULE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SEC_CTRL_RAM3_SLAVE_RULE to value 0"]
impl crate::Resettable for SEC_CTRL_RAM3_SLAVE_RULE_SPEC {
    #[inline(always)]
