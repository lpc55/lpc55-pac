#[doc = "Reader of register MATCHn_L"]
pub type R = crate::R<u32, super::MATCHN_L>;
#[doc = "Writer for register MATCHn_L"]
pub type W = crate::W<u32, super::MATCHN_L>;
#[doc = "Register MATCHn_L `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHN_L {
    type Type = u32;
    #[inline(always)]
...
pub type MATCHN_VALUE_R = crate::R<u32, u32>;
...
impl R {
    ...
    pub fn matchn_value(&self) -> MATCHN_VALUE_R {
        MATCHN_VALUE_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - The value written to the MATCH (L/H) register pair is compared against the central EVTIMER. When a match occurs, an interrupt request is generated if enabled. A separate pair of MATCH registers are implemented for each CPU. Each CPU reads its own local value at the same pair of addresses."]
