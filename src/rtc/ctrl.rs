...
impl core::ops::Deref for RTC_OSC_BYPASS_R {
    type Target = crate::FieldReader<bool, RTC_OSC_BYPASS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::ops::Deref for RTC_SUBSEC_ENA_R {
    type Target = crate::FieldReader<bool, RTC_SUBSEC_ENA_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
