...
pub struct R(crate::R<PRESETCTRLSET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRESETCTRLSET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PRESETCTRLSET_SPEC>> for R {
    fn from(reader: crate::R<PRESETCTRLSET_SPEC>) -> Self {
        R(reader)
    }
}
...
impl crate::Readable for PRESETCTRLSET_SPEC {
    type Reader = R;
}
