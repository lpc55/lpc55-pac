...
pub struct R(crate::R<CTIMERCLKSEL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CTIMERCLKSEL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CTIMERCLKSEL2_SPEC>> for R {
    fn from(reader: crate::R<CTIMERCLKSEL2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CTIMERCLKSEL2` writer"]
pub struct W(crate::W<CTIMERCLKSEL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CTIMERCLKSEL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CTIMERCLKSEL2_SPEC>> for W {
    fn from(writer: crate::W<CTIMERCLKSEL2_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CTimer 2 clock source select\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ctimerclksel2](index.html) module"]
pub struct CTIMERCLKSEL2_SPEC;
impl crate::RegisterSpec for CTIMERCLKSEL2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ctimerclksel2::R](R) reader structure"]
impl crate::Readable for CTIMERCLKSEL2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ctimerclksel2::W](W) writer structure"]
impl crate::Writable for CTIMERCLKSEL2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CTIMERCLKSEL2 to value 0x07"]
impl crate::Resettable for CTIMERCLKSEL2_SPEC {
    #[inline(always)]
