...
pub struct R(crate::R<CTIMERCLKSEL3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CTIMERCLKSEL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CTIMERCLKSEL3_SPEC>> for R {
    fn from(reader: crate::R<CTIMERCLKSEL3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CTIMERCLKSEL3` writer"]
pub struct W(crate::W<CTIMERCLKSEL3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CTIMERCLKSEL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CTIMERCLKSEL3_SPEC>> for W {
    fn from(writer: crate::W<CTIMERCLKSEL3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct CTIMERCLKSEL3_SPEC;
impl crate::RegisterSpec for CTIMERCLKSEL3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ctimerclksel3::R](R) reader structure"]
impl crate::Readable for CTIMERCLKSEL3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ctimerclksel3::W](W) writer structure"]
impl crate::Writable for CTIMERCLKSEL3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CTIMERCLKSEL3 to value 0x07"]
impl crate::Resettable for CTIMERCLKSEL3_SPEC {
    #[inline(always)]
