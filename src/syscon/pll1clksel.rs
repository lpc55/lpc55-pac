...
pub struct R(crate::R<PLL1CLKSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL1CLKSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PLL1CLKSEL_SPEC>> for R {
    fn from(reader: crate::R<PLL1CLKSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PLL1CLKSEL` writer"]
pub struct W(crate::W<PLL1CLKSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PLL1CLKSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PLL1CLKSEL_SPEC>> for W {
    fn from(writer: crate::W<PLL1CLKSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PLL1 clock source select\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll1clksel](index.html) module"]
pub struct PLL1CLKSEL_SPEC;
impl crate::RegisterSpec for PLL1CLKSEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll1clksel::R](R) reader structure"]
impl crate::Readable for PLL1CLKSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pll1clksel::W](W) writer structure"]
impl crate::Writable for PLL1CLKSEL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PLL1CLKSEL to value 0x07"]
impl crate::Resettable for PLL1CLKSEL_SPEC {
    #[inline(always)]
