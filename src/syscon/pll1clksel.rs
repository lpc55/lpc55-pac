#[doc = "Reader of register PLL1CLKSEL"]
pub type R = crate::R<u32, super::PLL1CLKSEL>;
#[doc = "Writer for register PLL1CLKSEL"]
pub type W = crate::W<u32, super::PLL1CLKSEL>;
#[doc = "Register PLL1CLKSEL `reset()`'s with value 0x07"]
impl crate::ResetValue for super::PLL1CLKSEL {
    type Type = u32;
    #[inline(always)]
