...
#[doc = "Writer for register PLL0STAT"]
pub type W = crate::W<u32, super::PLL0STAT>;
#[doc = "Register PLL0STAT `reset()`'s with value 0"]
impl crate::ResetValue for super::PLL0STAT {
    type Type = u32;
    #[inline(always)]
