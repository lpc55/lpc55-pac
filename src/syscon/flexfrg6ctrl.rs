...
pub struct R(crate::R<FLEXFRG6CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FLEXFRG6CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<FLEXFRG6CTRL_SPEC>> for R {
    fn from(reader: crate::R<FLEXFRG6CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FLEXFRG6CTRL` writer"]
pub struct W(crate::W<FLEXFRG6CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FLEXFRG6CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<FLEXFRG6CTRL_SPEC>> for W {
    fn from(writer: crate::W<FLEXFRG6CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Fractional rate divider for flexcomm 6\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [flexfrg6ctrl](index.html) module"]
pub struct FLEXFRG6CTRL_SPEC;
impl crate::RegisterSpec for FLEXFRG6CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [flexfrg6ctrl::R](R) reader structure"]
impl crate::Readable for FLEXFRG6CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [flexfrg6ctrl::W](W) writer structure"]
impl crate::Writable for FLEXFRG6CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FLEXFRG6CTRL to value 0xff"]
impl crate::Resettable for FLEXFRG6CTRL_SPEC {
    #[inline(always)]
