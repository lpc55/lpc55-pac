...
impl FRMENR {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> FRMENR {
        match value {
            false => FRMENR::DISABLE,
            true => FRMENR::ENABLE,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLE`"]
...
#[doc = "Values that can be written to the field `FRMEN`"]
pub enum FRMENW {
    #[doc = "free running mode is disable."]
    DISABLE,
    #[doc = "free running mode is enable."]
...
impl<'a> _FRMENW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: FRMENW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn disable(self) -> &'a mut W {
        self.variant(FRMENW::DISABLE)
    }
    #[doc = "free running mode is enable."]
    #[inline]
    pub fn enable(self) -> &'a mut W {
        self.variant(FRMENW::ENABLE)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
