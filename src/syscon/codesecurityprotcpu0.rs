#[doc = "Writer for register CODESECURITYPROTCPU0"]
pub type W = crate::W<u32, super::CODESECURITYPROTCPU0>;
#[doc = "Register CODESECURITYPROTCPU0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CODESECURITYPROTCPU0 {
    type Type = u32;
    #[inline(always)]
...
pub enum SEC_CODE_AW {
    #[doc = "CPU0 DAP is not allowed."]
    DISABLE,
    #[doc = "Security code to allow CPU0 DAP."]
    ENABLE,
}
...
impl W {
    #[doc = "Bits 0:31 - Security code to allow CPU0 DAP: 0x12345678."]
    #[inline(always)]
