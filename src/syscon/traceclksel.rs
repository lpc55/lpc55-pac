#[doc = "Reader of register TRACECLKSEL"]
pub type R = crate::R<u32, super::TRACECLKSEL>;
#[doc = "Writer for register TRACECLKSEL"]
pub type W = crate::W<u32, super::TRACECLKSEL>;
#[doc = "Register TRACECLKSEL `reset()`'s with value 0x07"]
impl crate::ResetValue for super::TRACECLKSEL {
    type Type = u32;
    #[inline(always)]
