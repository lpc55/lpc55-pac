...
pub struct R(crate::R<FCCLKSEL_FCCLKSEL7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FCCLKSEL_FCCLKSEL7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<FCCLKSEL_FCCLKSEL7_SPEC>> for R {
    fn from(reader: crate::R<FCCLKSEL_FCCLKSEL7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FCCLKSEL7` writer"]
pub struct W(crate::W<FCCLKSEL_FCCLKSEL7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FCCLKSEL_FCCLKSEL7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<FCCLKSEL_FCCLKSEL7_SPEC>> for W {
    fn from(writer: crate::W<FCCLKSEL_FCCLKSEL7_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Flexcomm Interface 7 clock source select for Fractional Rate Divider\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [fcclksel_fcclksel7](index.html) module"]
pub struct FCCLKSEL_FCCLKSEL7_SPEC;
impl crate::RegisterSpec for FCCLKSEL_FCCLKSEL7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [fcclksel_fcclksel7::R](R) reader structure"]
impl crate::Readable for FCCLKSEL_FCCLKSEL7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [fcclksel_fcclksel7::W](W) writer structure"]
impl crate::Writable for FCCLKSEL_FCCLKSEL7_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FCCLKSEL7 to value 0x07"]
impl crate::Resettable for FCCLKSEL_FCCLKSEL7_SPEC {
    #[inline(always)]
