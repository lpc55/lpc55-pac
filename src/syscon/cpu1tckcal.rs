#[doc = "Reader of register CPU1TCKCAL"]
pub type R = crate::R<u32, super::CPU1TCKCAL>;
#[doc = "Writer for register CPU1TCKCAL"]
pub type W = crate::W<u32, super::CPU1TCKCAL>;
#[doc = "Register CPU1TCKCAL `reset()`'s with value 0"]
impl crate::ResetValue for super::CPU1TCKCAL {
    type Type = u32;
    #[inline(always)]
