...
#[doc = r" Proxy"]
pub struct _PERIPHERALSW<'a> {
    w: &'a mut W,
}
impl<'a> _PERIPHERALSW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn peripherals(&self) -> PERIPHERALSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 1 - Wake for Flexcomms."]
    #[inline]
    pub fn peripherals(&mut self) -> _PERIPHERALSW {
        _PERIPHERALSW { w: self }
    }
    #[doc = "Bit 3 - Wake for DMA0."]
    #[inline]
