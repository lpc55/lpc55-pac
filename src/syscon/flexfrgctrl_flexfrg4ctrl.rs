...
pub struct R(crate::R<FLEXFRGCTRL_FLEXFRG4CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FLEXFRGCTRL_FLEXFRG4CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<FLEXFRGCTRL_FLEXFRG4CTRL_SPEC>> for R {
    fn from(reader: crate::R<FLEXFRGCTRL_FLEXFRG4CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FLEXFRG4CTRL` writer"]
pub struct W(crate::W<FLEXFRGCTRL_FLEXFRG4CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FLEXFRGCTRL_FLEXFRG4CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<FLEXFRGCTRL_FLEXFRG4CTRL_SPEC>> for W {
    fn from(writer: crate::W<FLEXFRGCTRL_FLEXFRG4CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Fractional rate divider for flexcomm 4\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [flexfrgctrl_flexfrg4ctrl](index.html) module"]
pub struct FLEXFRGCTRL_FLEXFRG4CTRL_SPEC;
impl crate::RegisterSpec for FLEXFRGCTRL_FLEXFRG4CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [flexfrgctrl_flexfrg4ctrl::R](R) reader structure"]
impl crate::Readable for FLEXFRGCTRL_FLEXFRG4CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [flexfrgctrl_flexfrg4ctrl::W](W) writer structure"]
impl crate::Writable for FLEXFRGCTRL_FLEXFRG4CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FLEXFRG4CTRL to value 0xff"]
impl crate::Resettable for FLEXFRGCTRL_FLEXFRG4CTRL_SPEC {
    #[inline(always)]
