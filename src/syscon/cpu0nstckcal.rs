#[doc = "Reader of register CPU0NSTCKCAL"]
pub type R = crate::R<u32, super::CPU0NSTCKCAL>;
#[doc = "Writer for register CPU0NSTCKCAL"]
pub type W = crate::W<u32, super::CPU0NSTCKCAL>;
#[doc = "Register CPU0NSTCKCAL `reset()`'s with value 0"]
impl crate::ResetValue for super::CPU0NSTCKCAL {
    type Type = u32;
    #[inline(always)]
