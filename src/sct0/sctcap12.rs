#[doc = "Reader of register SCTCAP12"]
pub type R = crate::R<u32, super::SCTCAP12>;
#[doc = "Writer for register SCTCAP12"]
pub type W = crate::W<u32, super::SCTCAP12>;
#[doc = "Register SCTCAP12 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP12 {
    type Type = u32;
    #[inline(always)]
