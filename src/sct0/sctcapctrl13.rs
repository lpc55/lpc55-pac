#[doc = "Reader of register SCTCAPCTRL13"]
pub type R = crate::R<u32, super::SCTCAPCTRL13>;
#[doc = "Writer for register SCTCAPCTRL13"]
pub type W = crate::W<u32, super::SCTCAPCTRL13>;
#[doc = "Register SCTCAPCTRL13 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL13 {
    type Type = u32;
    #[inline(always)]
