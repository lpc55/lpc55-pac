#[doc = "Reader of register SCTCAP14"]
pub type R = crate::R<u32, super::SCTCAP14>;
#[doc = "Writer for register SCTCAP14"]
pub type W = crate::W<u32, super::SCTCAP14>;
#[doc = "Register SCTCAP14 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP14 {
    type Type = u32;
    #[inline(always)]
