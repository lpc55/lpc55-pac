#[doc = "Reader of register SCTCAPCTRL11"]
pub type R = crate::R<u32, super::SCTCAPCTRL11>;
#[doc = "Writer for register SCTCAPCTRL11"]
pub type W = crate::W<u32, super::SCTCAPCTRL11>;
#[doc = "Register SCTCAPCTRL11 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL11 {
    type Type = u32;
    #[inline(always)]
