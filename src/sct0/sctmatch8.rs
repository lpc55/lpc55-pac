#[doc = "Reader of register SCTMATCH8"]
pub type R = crate::R<u32, super::SCTMATCH8>;
#[doc = "Writer for register SCTMATCH8"]
pub type W = crate::W<u32, super::SCTMATCH8>;
#[doc = "Register SCTMATCH8 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH8 {
    type Type = u32;
    #[inline(always)]
