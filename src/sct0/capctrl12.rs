#[doc = "Reader of register CAPCTRL12"]
pub type R = crate::R<u32, super::CAPCTRL12>;
#[doc = "Writer for register CAPCTRL12"]
pub type W = crate::W<u32, super::CAPCTRL12>;
#[doc = "Register CAPCTRL12 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL12 {
    type Type = u32;
    #[inline(always)]
