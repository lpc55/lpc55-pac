#[doc = "Reader of register SCTMATCHREL10"]
pub type R = crate::R<u32, super::SCTMATCHREL10>;
#[doc = "Writer for register SCTMATCHREL10"]
pub type W = crate::W<u32, super::SCTMATCHREL10>;
#[doc = "Register SCTMATCHREL10 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL10 {
    type Type = u32;
    #[inline(always)]
