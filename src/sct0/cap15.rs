#[doc = "Reader of register CAP15"]
pub type R = crate::R<u32, super::CAP15>;
#[doc = "Writer for register CAP15"]
pub type W = crate::W<u32, super::CAP15>;
#[doc = "Register CAP15 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP15 {
    type Type = u32;
    #[inline(always)]
