#[doc = "Reader of register SCTMATCH12"]
pub type R = crate::R<u32, super::SCTMATCH12>;
#[doc = "Writer for register SCTMATCH12"]
pub type W = crate::W<u32, super::SCTMATCH12>;
#[doc = "Register SCTMATCH12 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH12 {
    type Type = u32;
    #[inline(always)]
