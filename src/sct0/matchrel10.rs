#[doc = "Reader of register MATCHREL10"]
pub type R = crate::R<u32, super::MATCHREL10>;
#[doc = "Writer for register MATCHREL10"]
pub type W = crate::W<u32, super::MATCHREL10>;
#[doc = "Register MATCHREL10 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL10 {
    type Type = u32;
    #[inline(always)]
