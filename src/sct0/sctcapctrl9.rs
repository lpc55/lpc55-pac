#[doc = "Reader of register SCTCAPCTRL9"]
pub type R = crate::R<u32, super::SCTCAPCTRL9>;
#[doc = "Writer for register SCTCAPCTRL9"]
pub type W = crate::W<u32, super::SCTCAPCTRL9>;
#[doc = "Register SCTCAPCTRL9 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL9 {
    type Type = u32;
    #[inline(always)]
