#[doc = "Reader of register SCTCAPCTRL10"]
pub type R = crate::R<u32, super::SCTCAPCTRL10>;
#[doc = "Writer for register SCTCAPCTRL10"]
pub type W = crate::W<u32, super::SCTCAPCTRL10>;
#[doc = "Register SCTCAPCTRL10 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL10 {
    type Type = u32;
    #[inline(always)]
