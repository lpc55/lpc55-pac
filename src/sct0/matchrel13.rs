#[doc = "Reader of register MATCHREL13"]
pub type R = crate::R<u32, super::MATCHREL13>;
#[doc = "Writer for register MATCHREL13"]
pub type W = crate::W<u32, super::MATCHREL13>;
#[doc = "Register MATCHREL13 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL13 {
    type Type = u32;
    #[inline(always)]
