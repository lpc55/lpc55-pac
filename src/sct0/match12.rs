...
pub struct R(crate::R<MATCH12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATCH12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<MATCH12_SPEC>> for R {
    fn from(reader: crate::R<MATCH12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATCH12` writer"]
pub struct W(crate::W<MATCH12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATCH12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<MATCH12_SPEC>> for W {
    fn from(writer: crate::W<MATCH12_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "SCT match value register of match channels\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [match12](index.html) module"]
pub struct MATCH12_SPEC;
impl crate::RegisterSpec for MATCH12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [match12::R](R) reader structure"]
impl crate::Readable for MATCH12_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [match12::W](W) writer structure"]
impl crate::Writable for MATCH12_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MATCH12 to value 0"]
impl crate::Resettable for MATCH12_SPEC {
    #[inline(always)]
