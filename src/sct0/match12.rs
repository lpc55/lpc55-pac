#[doc = "Reader of register MATCH12"]
pub type R = crate::R<u32, super::MATCH12>;
#[doc = "Writer for register MATCH12"]
pub type W = crate::W<u32, super::MATCH12>;
#[doc = "Register MATCH12 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH12 {
    type Type = u32;
    #[inline(always)]
