#[doc = "Reader of register MATCH11"]
pub type R = crate::R<u32, super::MATCH11>;
#[doc = "Writer for register MATCH11"]
pub type W = crate::W<u32, super::MATCH11>;
#[doc = "Register MATCH11 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH11 {
    type Type = u32;
    #[inline(always)]
