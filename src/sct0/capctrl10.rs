#[doc = "Reader of register CAPCTRL10"]
pub type R = crate::R<u32, super::CAPCTRL10>;
#[doc = "Writer for register CAPCTRL10"]
pub type W = crate::W<u32, super::CAPCTRL10>;
#[doc = "Register CAPCTRL10 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL10 {
    type Type = u32;
    #[inline(always)]
