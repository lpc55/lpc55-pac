#[doc = "Reader of register SCTMATCH14"]
pub type R = crate::R<u32, super::SCTMATCH14>;
#[doc = "Writer for register SCTMATCH14"]
pub type W = crate::W<u32, super::SCTMATCH14>;
#[doc = "Register SCTMATCH14 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH14 {
    type Type = u32;
    #[inline(always)]
