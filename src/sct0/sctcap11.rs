#[doc = "Reader of register SCTCAP11"]
pub type R = crate::R<u32, super::SCTCAP11>;
#[doc = "Writer for register SCTCAP11"]
pub type W = crate::W<u32, super::SCTCAP11>;
#[doc = "Register SCTCAP11 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP11 {
    type Type = u32;
    #[inline(always)]
