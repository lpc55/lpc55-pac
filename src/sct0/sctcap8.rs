#[doc = "Reader of register SCTCAP8"]
pub type R = crate::R<u32, super::SCTCAP8>;
#[doc = "Writer for register SCTCAP8"]
pub type W = crate::W<u32, super::SCTCAP8>;
#[doc = "Register SCTCAP8 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP8 {
    type Type = u32;
    #[inline(always)]
