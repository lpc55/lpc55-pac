...
pub struct R(crate::R<MATCHREL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATCHREL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<MATCHREL2_SPEC>> for R {
    fn from(reader: crate::R<MATCHREL2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATCHREL2` writer"]
pub struct W(crate::W<MATCHREL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATCHREL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<MATCHREL2_SPEC>> for W {
    fn from(writer: crate::W<MATCHREL2_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "SCT match reload value register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [matchrel2](index.html) module"]
pub struct MATCHREL2_SPEC;
impl crate::RegisterSpec for MATCHREL2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [matchrel2::R](R) reader structure"]
impl crate::Readable for MATCHREL2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [matchrel2::W](W) writer structure"]
impl crate::Writable for MATCHREL2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MATCHREL2 to value 0"]
impl crate::Resettable for MATCHREL2_SPEC {
    #[inline(always)]
