#[doc = "Reader of register CAPCTRL15"]
pub type R = crate::R<u32, super::CAPCTRL15>;
#[doc = "Writer for register CAPCTRL15"]
pub type W = crate::W<u32, super::CAPCTRL15>;
#[doc = "Register CAPCTRL15 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL15 {
    type Type = u32;
    #[inline(always)]
