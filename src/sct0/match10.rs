#[doc = "Reader of register MATCH10"]
pub type R = crate::R<u32, super::MATCH10>;
#[doc = "Writer for register MATCH10"]
pub type W = crate::W<u32, super::MATCH10>;
#[doc = "Register MATCH10 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH10 {
    type Type = u32;
    #[inline(always)]
