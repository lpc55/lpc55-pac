#[doc = "Reader of register MATCHREL12"]
pub type R = crate::R<u32, super::MATCHREL12>;
#[doc = "Writer for register MATCHREL12"]
pub type W = crate::W<u32, super::MATCHREL12>;
#[doc = "Register MATCHREL12 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL12 {
    type Type = u32;
    #[inline(always)]
