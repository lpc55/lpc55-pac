#[doc = "Reader of register CAPCTRL11"]
pub type R = crate::R<u32, super::CAPCTRL11>;
#[doc = "Writer for register CAPCTRL11"]
pub type W = crate::W<u32, super::CAPCTRL11>;
#[doc = "Register CAPCTRL11 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL11 {
    type Type = u32;
    #[inline(always)]
