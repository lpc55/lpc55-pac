#[doc = "Reader of register SCTCAPCTRL8"]
pub type R = crate::R<u32, super::SCTCAPCTRL8>;
#[doc = "Writer for register SCTCAPCTRL8"]
pub type W = crate::W<u32, super::SCTCAPCTRL8>;
#[doc = "Register SCTCAPCTRL8 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL8 {
    type Type = u32;
    #[inline(always)]
