#[doc = "Reader of register SCTMATCH13"]
pub type R = crate::R<u32, super::SCTMATCH13>;
#[doc = "Writer for register SCTMATCH13"]
pub type W = crate::W<u32, super::SCTMATCH13>;
#[doc = "Register SCTMATCH13 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH13 {
    type Type = u32;
    #[inline(always)]
