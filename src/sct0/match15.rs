#[doc = "Reader of register MATCH15"]
pub type R = crate::R<u32, super::MATCH15>;
#[doc = "Writer for register MATCH15"]
pub type W = crate::W<u32, super::MATCH15>;
#[doc = "Register MATCH15 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH15 {
    type Type = u32;
    #[inline(always)]
