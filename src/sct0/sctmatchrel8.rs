#[doc = "Reader of register SCTMATCHREL8"]
pub type R = crate::R<u32, super::SCTMATCHREL8>;
#[doc = "Writer for register SCTMATCHREL8"]
pub type W = crate::W<u32, super::SCTMATCHREL8>;
#[doc = "Register SCTMATCHREL8 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL8 {
    type Type = u32;
    #[inline(always)]
