#[doc = "Reader of register MATCH14"]
pub type R = crate::R<u32, super::MATCH14>;
#[doc = "Writer for register MATCH14"]
pub type W = crate::W<u32, super::MATCH14>;
#[doc = "Register MATCH14 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH14 {
    type Type = u32;
    #[inline(always)]
