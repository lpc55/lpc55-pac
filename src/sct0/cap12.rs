#[doc = "Reader of register CAP12"]
pub type R = crate::R<u32, super::CAP12>;
#[doc = "Writer for register CAP12"]
pub type W = crate::W<u32, super::CAP12>;
#[doc = "Register CAP12 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP12 {
    type Type = u32;
    #[inline(always)]
