...
pub struct R(crate::R<CAP12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CAP12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CAP12_SPEC>> for R {
    fn from(reader: crate::R<CAP12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CAP12` writer"]
pub struct W(crate::W<CAP12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAP12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CAP12_SPEC>> for W {
    fn from(writer: crate::W<CAP12_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "SCT capture register of capture channel\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cap12](index.html) module"]
pub struct CAP12_SPEC;
impl crate::RegisterSpec for CAP12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cap12::R](R) reader structure"]
impl crate::Readable for CAP12_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cap12::W](W) writer structure"]
impl crate::Writable for CAP12_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CAP12 to value 0"]
impl crate::Resettable for CAP12_SPEC {
    #[inline(always)]
