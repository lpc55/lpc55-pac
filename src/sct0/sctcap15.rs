#[doc = "Reader of register SCTCAP15"]
pub type R = crate::R<u32, super::SCTCAP15>;
#[doc = "Writer for register SCTCAP15"]
pub type W = crate::W<u32, super::SCTCAP15>;
#[doc = "Register SCTCAP15 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP15 {
    type Type = u32;
    #[inline(always)]
