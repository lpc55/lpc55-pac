...
pub struct R(crate::R<MATCH3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATCH3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<MATCH3_SPEC>> for R {
    fn from(reader: crate::R<MATCH3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATCH3` writer"]
pub struct W(crate::W<MATCH3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATCH3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<MATCH3_SPEC>> for W {
    fn from(writer: crate::W<MATCH3_SPEC>) -> Self {
        W(writer)
    }
}
