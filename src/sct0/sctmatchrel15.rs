#[doc = "Reader of register SCTMATCHREL15"]
pub type R = crate::R<u32, super::SCTMATCHREL15>;
#[doc = "Writer for register SCTMATCHREL15"]
pub type W = crate::W<u32, super::SCTMATCHREL15>;
#[doc = "Register SCTMATCHREL15 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL15 {
    type Type = u32;
    #[inline(always)]
