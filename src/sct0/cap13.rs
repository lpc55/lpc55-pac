#[doc = "Reader of register CAP13"]
pub type R = crate::R<u32, super::CAP13>;
#[doc = "Writer for register CAP13"]
pub type W = crate::W<u32, super::CAP13>;
#[doc = "Register CAP13 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP13 {
    type Type = u32;
    #[inline(always)]
