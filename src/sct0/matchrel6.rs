...
pub struct R(crate::R<MATCHREL6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATCHREL6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<MATCHREL6_SPEC>> for R {
    fn from(reader: crate::R<MATCHREL6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATCHREL6` writer"]
pub struct W(crate::W<MATCHREL6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATCHREL6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<MATCHREL6_SPEC>> for W {
    fn from(writer: crate::W<MATCHREL6_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "SCT match reload value register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [matchrel6](index.html) module"]
pub struct MATCHREL6_SPEC;
impl crate::RegisterSpec for MATCHREL6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [matchrel6::R](R) reader structure"]
impl crate::Readable for MATCHREL6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [matchrel6::W](W) writer structure"]
impl crate::Writable for MATCHREL6_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MATCHREL6 to value 0"]
impl crate::Resettable for MATCHREL6_SPEC {
    #[inline(always)]
