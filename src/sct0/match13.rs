#[doc = "Reader of register MATCH13"]
pub type R = crate::R<u32, super::MATCH13>;
#[doc = "Writer for register MATCH13"]
pub type W = crate::W<u32, super::MATCH13>;
#[doc = "Register MATCH13 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCH13 {
    type Type = u32;
    #[inline(always)]
