#[doc = "Reader of register MATCHREL11"]
pub type R = crate::R<u32, super::MATCHREL11>;
#[doc = "Writer for register MATCHREL11"]
pub type W = crate::W<u32, super::MATCHREL11>;
#[doc = "Register MATCHREL11 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL11 {
    type Type = u32;
    #[inline(always)]
