#[doc = "Reader of register SCTMATCH9"]
pub type R = crate::R<u32, super::SCTMATCH9>;
#[doc = "Writer for register SCTMATCH9"]
pub type W = crate::W<u32, super::SCTMATCH9>;
#[doc = "Register SCTMATCH9 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH9 {
    type Type = u32;
    #[inline(always)]
