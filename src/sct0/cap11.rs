#[doc = "Reader of register CAP11"]
pub type R = crate::R<u32, super::CAP11>;
#[doc = "Writer for register CAP11"]
pub type W = crate::W<u32, super::CAP11>;
#[doc = "Register CAP11 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP11 {
    type Type = u32;
    #[inline(always)]
