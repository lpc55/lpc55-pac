#[doc = "Reader of register SCTCAPCTRL14"]
pub type R = crate::R<u32, super::SCTCAPCTRL14>;
#[doc = "Writer for register SCTCAPCTRL14"]
pub type W = crate::W<u32, super::SCTCAPCTRL14>;
#[doc = "Register SCTCAPCTRL14 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL14 {
    type Type = u32;
    #[inline(always)]
