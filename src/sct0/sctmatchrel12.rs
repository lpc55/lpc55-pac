#[doc = "Reader of register SCTMATCHREL12"]
pub type R = crate::R<u32, super::SCTMATCHREL12>;
#[doc = "Writer for register SCTMATCHREL12"]
pub type W = crate::W<u32, super::SCTMATCHREL12>;
#[doc = "Register SCTMATCHREL12 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL12 {
    type Type = u32;
    #[inline(always)]
