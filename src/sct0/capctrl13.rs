#[doc = "Reader of register CAPCTRL13"]
pub type R = crate::R<u32, super::CAPCTRL13>;
#[doc = "Writer for register CAPCTRL13"]
pub type W = crate::W<u32, super::CAPCTRL13>;
#[doc = "Register CAPCTRL13 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL13 {
    type Type = u32;
    #[inline(always)]
