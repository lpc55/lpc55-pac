#[doc = "Reader of register SCTMATCH11"]
pub type R = crate::R<u32, super::SCTMATCH11>;
#[doc = "Writer for register SCTMATCH11"]
pub type W = crate::W<u32, super::SCTMATCH11>;
#[doc = "Register SCTMATCH11 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH11 {
    type Type = u32;
    #[inline(always)]
