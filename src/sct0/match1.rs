...
pub struct R(crate::R<MATCH1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATCH1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<MATCH1_SPEC>> for R {
    fn from(reader: crate::R<MATCH1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATCH1` writer"]
pub struct W(crate::W<MATCH1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATCH1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<MATCH1_SPEC>> for W {
    fn from(writer: crate::W<MATCH1_SPEC>) -> Self {
        W(writer)
    }
}
