...
pub struct R(crate::R<MATCHREL3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATCHREL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<MATCHREL3_SPEC>> for R {
    fn from(reader: crate::R<MATCHREL3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATCHREL3` writer"]
pub struct W(crate::W<MATCHREL3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATCHREL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<MATCHREL3_SPEC>> for W {
    fn from(writer: crate::W<MATCHREL3_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "SCT match reload value register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [matchrel3](index.html) module"]
pub struct MATCHREL3_SPEC;
impl crate::RegisterSpec for MATCHREL3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [matchrel3::R](R) reader structure"]
impl crate::Readable for MATCHREL3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [matchrel3::W](W) writer structure"]
impl crate::Writable for MATCHREL3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MATCHREL3 to value 0"]
impl crate::Resettable for MATCHREL3_SPEC {
    #[inline(always)]
