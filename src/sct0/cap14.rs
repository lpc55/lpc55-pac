#[doc = "Reader of register CAP14"]
pub type R = crate::R<u32, super::CAP14>;
#[doc = "Writer for register CAP14"]
pub type W = crate::W<u32, super::CAP14>;
#[doc = "Register CAP14 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAP14 {
    type Type = u32;
    #[inline(always)]
