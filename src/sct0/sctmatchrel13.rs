#[doc = "Reader of register SCTMATCHREL13"]
pub type R = crate::R<u32, super::SCTMATCHREL13>;
#[doc = "Writer for register SCTMATCHREL13"]
pub type W = crate::W<u32, super::SCTMATCHREL13>;
#[doc = "Register SCTMATCHREL13 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL13 {
    type Type = u32;
    #[inline(always)]
