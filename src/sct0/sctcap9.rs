#[doc = "Reader of register SCTCAP9"]
pub type R = crate::R<u32, super::SCTCAP9>;
#[doc = "Writer for register SCTCAP9"]
pub type W = crate::W<u32, super::SCTCAP9>;
#[doc = "Register SCTCAP9 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP9 {
    type Type = u32;
    #[inline(always)]
