#[doc = "Reader of register SCTCAP13"]
pub type R = crate::R<u32, super::SCTCAP13>;
#[doc = "Writer for register SCTCAP13"]
pub type W = crate::W<u32, super::SCTCAP13>;
#[doc = "Register SCTCAP13 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP13 {
    type Type = u32;
    #[inline(always)]
