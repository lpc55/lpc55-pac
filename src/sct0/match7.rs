...
pub struct R(crate::R<MATCH7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATCH7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MATCH7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MATCH7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATCH7` writer"]
pub struct W(crate::W<MATCH7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATCH7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MATCH7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MATCH7_SPEC>) -> Self {
        W(writer)
    }
}
