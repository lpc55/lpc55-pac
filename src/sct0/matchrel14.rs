#[doc = "Reader of register MATCHREL14"]
pub type R = crate::R<u32, super::MATCHREL14>;
#[doc = "Writer for register MATCHREL14"]
pub type W = crate::W<u32, super::MATCHREL14>;
#[doc = "Register MATCHREL14 `reset()`'s with value 0"]
impl crate::ResetValue for super::MATCHREL14 {
    type Type = u32;
    #[inline(always)]
