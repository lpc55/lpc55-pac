#[doc = "Reader of register SCTMATCH15"]
pub type R = crate::R<u32, super::SCTMATCH15>;
#[doc = "Writer for register SCTMATCH15"]
pub type W = crate::W<u32, super::SCTMATCH15>;
#[doc = "Register SCTMATCH15 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH15 {
    type Type = u32;
    #[inline(always)]
