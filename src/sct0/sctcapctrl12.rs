#[doc = "Reader of register SCTCAPCTRL12"]
pub type R = crate::R<u32, super::SCTCAPCTRL12>;
#[doc = "Writer for register SCTCAPCTRL12"]
pub type W = crate::W<u32, super::SCTCAPCTRL12>;
#[doc = "Register SCTCAPCTRL12 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL12 {
    type Type = u32;
    #[inline(always)]
