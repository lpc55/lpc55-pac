#[doc = "Reader of register SCTCAP10"]
pub type R = crate::R<u32, super::SCTCAP10>;
#[doc = "Writer for register SCTCAP10"]
pub type W = crate::W<u32, super::SCTCAP10>;
#[doc = "Register SCTCAP10 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAP10 {
    type Type = u32;
    #[inline(always)]
