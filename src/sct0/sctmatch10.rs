#[doc = "Reader of register SCTMATCH10"]
pub type R = crate::R<u32, super::SCTMATCH10>;
#[doc = "Writer for register SCTMATCH10"]
pub type W = crate::W<u32, super::SCTMATCH10>;
#[doc = "Register SCTMATCH10 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCH10 {
    type Type = u32;
    #[inline(always)]
