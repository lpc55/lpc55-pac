#[doc = "Reader of register SCTCAPCTRL15"]
pub type R = crate::R<u32, super::SCTCAPCTRL15>;
#[doc = "Writer for register SCTCAPCTRL15"]
pub type W = crate::W<u32, super::SCTCAPCTRL15>;
#[doc = "Register SCTCAPCTRL15 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTCAPCTRL15 {
    type Type = u32;
    #[inline(always)]
