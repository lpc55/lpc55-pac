#[doc = "Reader of register CAPCTRL14"]
pub type R = crate::R<u32, super::CAPCTRL14>;
#[doc = "Writer for register CAPCTRL14"]
pub type W = crate::W<u32, super::CAPCTRL14>;
#[doc = "Register CAPCTRL14 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAPCTRL14 {
    type Type = u32;
    #[inline(always)]
