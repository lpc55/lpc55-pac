#[doc = "Reader of register SCTMATCHREL11"]
pub type R = crate::R<u32, super::SCTMATCHREL11>;
#[doc = "Writer for register SCTMATCHREL11"]
pub type W = crate::W<u32, super::SCTMATCHREL11>;
#[doc = "Register SCTMATCHREL11 `reset()`'s with value 0"]
impl crate::ResetValue for super::SCTMATCHREL11 {
    type Type = u32;
    #[inline(always)]
