...
impl From<crate::R<ADDRESS2_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<ADDRESS2_SPEC>> for W {
    #[inline(always)]
...
#[doc = "`reset()` method sets ADDRESS2 to value 0"]
impl crate::Resettable for ADDRESS2_SPEC {
    #[inline(always)]
