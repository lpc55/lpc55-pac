...
#[doc = r" Value of the field"]
pub struct SEND_AUTO_STOP_CCSDR {
    bits: bool,
}
impl SEND_AUTO_STOP_CCSDR {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Value of the field"]
pub struct CEATA_DEVICE_INTERRUPT_STATUSR {
    bits: bool,
}
...
impl R {
    ...
    #[inline]
    pub fn send_auto_stop_ccsd(&self) -> SEND_AUTO_STOP_CCSDR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 10;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        SEND_AUTO_STOP_CCSDR { bits }
    }
    ...
    pub fn ceata_device_interrupt_status(&self) -> CEATA_DEVICE_INTERRUPT_STATUSR {
        ...
        CEATA_DEVICE_INTERRUPT_STATUSR { bits }
    }
