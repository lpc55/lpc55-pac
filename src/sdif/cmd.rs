...
pub type CARD_NUMBER_R = crate::R<u8, CARD_NUMBER_A>;
impl CARD_NUMBER_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, CARD_NUMBER_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(CARD_NUMBER_A::CARD0),
            1 => Val(CARD_NUMBER_A::CARD1),
            i => Res(i),
        }
    }
...
#[doc = "Write proxy for field `CARD_NUMBER`"]
...
impl<'a> CARD_NUMBER_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: CARD_NUMBER_A) -> &'a mut W {
