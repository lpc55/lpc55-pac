...
#[doc = r" Proxy"]
pub struct _FIXEDOVERFLOWW<'a> {
    w: &'a mut W,
}
impl<'a> _FIXEDOVERFLOWW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 1 - nan"]
    #[inline]
    pub fn nan(&mut self) -> _NANW {
        _NANW { w: self }
    }
    #[doc = "Bit 2 - fixed_pt_overflow"]
    #[inline]
    pub fn fixedoverflow(&mut self) -> _FIXEDOVERFLOWW {
        _FIXEDOVERFLOWW { w: self }
    }
    #[doc = "Bit 3 - underflow"]
    #[inline]
    ...
    #[doc = "Bit 4 - bus_error"]
    #[inline]
    pub fn buserror(&mut self) -> _BUSERRORW {
        _BUSERRORW { w: self }
    }
}
