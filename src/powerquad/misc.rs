...
impl core::convert::From<crate::R<MISC_SPEC>> for R {
...
impl core::convert::From<crate::W<MISC_SPEC>> for W {
    fn from(writer: crate::W<MISC_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `inst_misc` reader - Misc register. For Matrix : Used for scale factor"]
pub struct INST_MISC_R(crate::FieldReader<u32, u32>);
impl INST_MISC_R {
    pub(crate) fn new(bits: u32) -> Self {
        INST_MISC_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INST_MISC_R {
...
pub struct INST_MISC_W<'a> {
    w: &'a mut W,
}
impl<'a> INST_MISC_W<'a> {
...
impl R {
    ...
    pub fn inst_misc(&self) -> INST_MISC_R {
        INST_MISC_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - Misc register. For Matrix : Used for scale factor"]
    #[inline(always)]
    pub fn inst_misc(&mut self) -> INST_MISC_W {
        INST_MISC_W { w: self }
    }
