#[doc = "Reader of register BASE_ADDR1"]
pub type R = crate::R<u32, super::BASE_ADDR1>;
#[doc = "Writer for register BASE_ADDR1"]
pub type W = crate::W<u32, super::BASE_ADDR1>;
#[doc = "Register BASE_ADDR1 `reset()`'s with value 0x0004_0000"]
impl crate::ResetValue for super::BASE_ADDR1 {
    type Type = u32;
    #[inline(always)]
