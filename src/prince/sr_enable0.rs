...
pub struct R(crate::R<SR_ENABLE0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SR_ENABLE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<SR_ENABLE0_SPEC>> for R {
    fn from(reader: crate::R<SR_ENABLE0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SR_ENABLE0` writer"]
pub struct W(crate::W<SR_ENABLE0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SR_ENABLE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<SR_ENABLE0_SPEC>> for W {
    fn from(writer: crate::W<SR_ENABLE0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Sub-Region Enable register for region 0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sr_enable0](index.html) module"]
pub struct SR_ENABLE0_SPEC;
impl crate::RegisterSpec for SR_ENABLE0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sr_enable0::R](R) reader structure"]
impl crate::Readable for SR_ENABLE0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sr_enable0::W](W) writer structure"]
impl crate::Writable for SR_ENABLE0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SR_ENABLE0 to value 0"]
impl crate::Resettable for SR_ENABLE0_SPEC {
    #[inline(always)]
