...
pub struct R(crate::R<TIMER3CAPTSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMER3CAPTSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<TIMER3CAPTSEL_SPEC>> for R {
    fn from(reader: crate::R<TIMER3CAPTSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMER3CAPTSEL[%s]` writer"]
pub struct W(crate::W<TIMER3CAPTSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMER3CAPTSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<TIMER3CAPTSEL_SPEC>> for W {
    fn from(writer: crate::W<TIMER3CAPTSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct TIMER3CAPTSEL_SPEC;
impl crate::RegisterSpec for TIMER3CAPTSEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timer3captsel::R](R) reader structure"]
impl crate::Readable for TIMER3CAPTSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timer3captsel::W](W) writer structure"]
impl crate::Writable for TIMER3CAPTSEL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TIMER3CAPTSEL[%s]
to value 0x1f"]
impl crate::Resettable for TIMER3CAPTSEL_SPEC {
    #[inline(always)]
