#[doc = "Reader of register TIMER3CAPTSEL[%s]"]
pub type R = crate::R<u32, super::TIMER3CAPTSEL>;
#[doc = "Writer for register TIMER3CAPTSEL[%s]"]
pub type W = crate::W<u32, super::TIMER3CAPTSEL>;
#[doc = "Register TIMER3CAPTSEL[%s]
`reset()`'s with value 0x1f"]
impl crate::ResetValue for super::TIMER3CAPTSEL {
    type Type = u32;
    #[inline(always)]
