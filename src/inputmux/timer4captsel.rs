...
pub struct R(crate::R<TIMER4CAPTSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMER4CAPTSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<TIMER4CAPTSEL_SPEC>> for R {
    fn from(reader: crate::R<TIMER4CAPTSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMER4CAPTSEL[%s]` writer"]
pub struct W(crate::W<TIMER4CAPTSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMER4CAPTSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<TIMER4CAPTSEL_SPEC>> for W {
    fn from(writer: crate::W<TIMER4CAPTSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Capture select registers for TIMER4 inputs\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timer4captsel](index.html) module"]
pub struct TIMER4CAPTSEL_SPEC;
impl crate::RegisterSpec for TIMER4CAPTSEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timer4captsel::R](R) reader structure"]
impl crate::Readable for TIMER4CAPTSEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timer4captsel::W](W) writer structure"]
impl crate::Writable for TIMER4CAPTSEL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TIMER4CAPTSEL[%s]
to value 0x1f"]
impl crate::Resettable for TIMER4CAPTSEL_SPEC {
    #[inline(always)]
