#[doc = "Reader of register TIMER1CAPTSEL[%s]"]
pub type R = crate::R<u32, super::TIMER1CAPTSEL>;
#[doc = "Writer for register TIMER1CAPTSEL[%s]"]
pub type W = crate::W<u32, super::TIMER1CAPTSEL>;
#[doc = "Register TIMER1CAPTSEL[%s]
`reset()`'s with value 0x1f"]
impl crate::ResetValue for super::TIMER1CAPTSEL {
    type Type = u32;
    #[inline(always)]
