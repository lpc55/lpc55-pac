#[doc = "Reader of register DMA0_OTRIG_INMUX[%s]"]
pub type R = crate::R<u32, super::DMA0_OTRIG_INMUX>;
#[doc = "Writer for register DMA0_OTRIG_INMUX[%s]"]
pub type W = crate::W<u32, super::DMA0_OTRIG_INMUX>;
#[doc = "Register DMA0_OTRIG_INMUX[%s]
`reset()`'s with value 0x1f"]
impl crate::ResetValue for super::DMA0_OTRIG_INMUX {
    type Type = u32;
    #[inline(always)]
