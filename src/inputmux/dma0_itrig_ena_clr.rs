...
pub struct W(crate::W<DMA0_ITRIG_ENA_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA0_ITRIG_ENA_CLR_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<DMA0_ITRIG_ENA_CLR_SPEC>> for W {
    fn from(writer: crate::W<DMA0_ITRIG_ENA_CLR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Clear one or several bits in DMA0_ITRIG_ENA register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma0_itrig_ena_clr](index.html) module"]
pub struct DMA0_ITRIG_ENA_CLR_SPEC;
impl crate::RegisterSpec for DMA0_ITRIG_ENA_CLR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [dma0_itrig_ena_clr::W](W) writer structure"]
impl crate::Writable for DMA0_ITRIG_ENA_CLR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMA0_ITRIG_ENA_CLR to value 0"]
impl crate::Resettable for DMA0_ITRIG_ENA_CLR_SPEC {
    #[inline(always)]
