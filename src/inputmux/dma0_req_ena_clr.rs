#[doc = "Writer for register DMA0_REQ_ENA_CLR"]
pub type W = crate::W<u32, super::DMA0_REQ_ENA_CLR>;
#[doc = "Register DMA0_REQ_ENA_CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA0_REQ_ENA_CLR {
    type Type = u32;
    #[inline(always)]
