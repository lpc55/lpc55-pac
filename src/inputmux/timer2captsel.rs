#[doc = "Reader of register TIMER2CAPTSEL[%s]"]
pub type R = crate::R<u32, super::TIMER2CAPTSEL>;
#[doc = "Writer for register TIMER2CAPTSEL[%s]"]
pub type W = crate::W<u32, super::TIMER2CAPTSEL>;
#[doc = "Register TIMER2CAPTSEL[%s]
`reset()`'s with value 0x1f"]
impl crate::ResetValue for super::TIMER2CAPTSEL {
    type Type = u32;
    #[inline(always)]
