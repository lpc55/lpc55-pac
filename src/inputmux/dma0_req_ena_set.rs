...
pub struct W(crate::W<DMA0_REQ_ENA_SET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA0_REQ_ENA_SET_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<DMA0_REQ_ENA_SET_SPEC>> for W {
    fn from(writer: crate::W<DMA0_REQ_ENA_SET_SPEC>) -> Self {
        W(writer)
    }
}
...
impl crate::Writable for DMA0_REQ_ENA_SET_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMA0_REQ_ENA_SET to value 0"]
impl crate::Resettable for DMA0_REQ_ENA_SET_SPEC {
    #[inline(always)]
