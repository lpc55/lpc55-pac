...
pub struct R(crate::R<RX_TOG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RX_TOG_SPEC>;
    #[inline(always)]
...
pub struct W(crate::W<RX_TOG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RX_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[doc = "USB PHY Receiver Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rx_tog](index.html) module"]
pub struct RX_TOG_SPEC;
impl crate::RegisterSpec for RX_TOG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rx_tog::R](R) reader structure"]
impl crate::Readable for RX_TOG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rx_tog::W](W) writer structure"]
impl crate::Writable for RX_TOG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RX_TOG to value 0"]
impl crate::Resettable for RX_TOG_SPEC {
    #[inline(always)]
