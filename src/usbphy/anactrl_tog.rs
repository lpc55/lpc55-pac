...
pub struct R(crate::R<ANACTRL_TOG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ANACTRL_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<ANACTRL_TOG_SPEC>> for R {
    fn from(reader: crate::R<ANACTRL_TOG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ANACTRL_TOG` writer"]
pub struct W(crate::W<ANACTRL_TOG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ANACTRL_TOG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<ANACTRL_TOG_SPEC>> for W {
    fn from(writer: crate::W<ANACTRL_TOG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "USB PHY Analog Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [anactrl_tog](index.html) module"]
pub struct ANACTRL_TOG_SPEC;
impl crate::RegisterSpec for ANACTRL_TOG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [anactrl_tog::R](R) reader structure"]
impl crate::Readable for ANACTRL_TOG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [anactrl_tog::W](W) writer structure"]
impl crate::Writable for ANACTRL_TOG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ANACTRL_TOG to value 0x0a00_0402"]
impl crate::Resettable for ANACTRL_TOG_SPEC {
    #[inline(always)]
