#[doc = "Reader of register PWD"]
pub type R = crate::R<u32, super::PWD>;
#[doc = "Writer for register PWD"]
pub type W = crate::W<u32, super::PWD>;
#[doc = "Register PWD `reset()`'s with value 0x001e_1c00"]
impl crate::ResetValue for super::PWD {
    type Type = u32;
    #[inline(always)]
