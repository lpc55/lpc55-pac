...
pub struct R(crate::R<SBKEY_HEADER1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SBKEY_HEADER1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<SBKEY_HEADER1_SPEC>> for R {
    fn from(reader: crate::R<SBKEY_HEADER1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SBKEY_HEADER1` writer"]
pub struct W(crate::W<SBKEY_HEADER1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SBKEY_HEADER1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<SBKEY_HEADER1_SPEC>> for W {
    fn from(writer: crate::W<SBKEY_HEADER1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct SBKEY_HEADER1_SPEC;
impl crate::RegisterSpec for SBKEY_HEADER1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sbkey_header1::R](R) reader structure"]
impl crate::Readable for SBKEY_HEADER1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sbkey_header1::W](W) writer structure"]
impl crate::Writable for SBKEY_HEADER1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SBKEY_HEADER1 to value 0"]
impl crate::Resettable for SBKEY_HEADER1_SPEC {
    #[inline(always)]
