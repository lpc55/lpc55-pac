#[doc = "Reader of register USER_KEK_HEADER1"]
pub type R = crate::R<u32, super::USER_KEK_HEADER1>;
#[doc = "Writer for register USER_KEK_HEADER1"]
pub type W = crate::W<u32, super::USER_KEK_HEADER1>;
#[doc = "Register USER_KEK_HEADER1 `reset()`'s with value 0"]
impl crate::ResetValue for super::USER_KEK_HEADER1 {
    type Type = u32;
    #[inline(always)]
