...
pub struct R(crate::R<USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC>> for R {
    fn from(reader: crate::R<USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USER_KEK_HEADER1` writer"]
pub struct W(crate::W<USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC>> for W {
    fn from(writer: crate::W<USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = ".\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [user_kek_key_code_user_kek_header1](index.html) module"]
pub struct USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC;
impl crate::RegisterSpec for USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [user_kek_key_code_user_kek_header1::R](R) reader structure"]
impl crate::Readable for USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [user_kek_key_code_user_kek_header1::W](W) writer structure"]
impl crate::Writable for USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets USER_KEK_HEADER1 to value 0"]
impl crate::Resettable for USER_KEK_KEY_CODE_USER_KEK_HEADER1_SPEC {
    #[inline(always)]
