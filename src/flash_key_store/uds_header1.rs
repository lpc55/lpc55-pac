...
pub struct R(crate::R<UDS_HEADER1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UDS_HEADER1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UDS_HEADER1_SPEC>> for R {
    fn from(reader: crate::R<UDS_HEADER1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UDS_HEADER1` writer"]
pub struct W(crate::W<UDS_HEADER1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UDS_HEADER1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<UDS_HEADER1_SPEC>> for W {
    fn from(writer: crate::W<UDS_HEADER1_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = ".\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uds_header1](index.html) module"]
pub struct UDS_HEADER1_SPEC;
impl crate::RegisterSpec for UDS_HEADER1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uds_header1::R](R) reader structure"]
impl crate::Readable for UDS_HEADER1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uds_header1::W](W) writer structure"]
impl crate::Writable for UDS_HEADER1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UDS_HEADER1 to value 0"]
impl crate::Resettable for UDS_HEADER1_SPEC {
    #[inline(always)]
