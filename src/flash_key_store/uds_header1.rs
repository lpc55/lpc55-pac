#[doc = "Reader of register UDS_HEADER1"]
pub type R = crate::R<u32, super::UDS_HEADER1>;
#[doc = "Writer for register UDS_HEADER1"]
pub type W = crate::W<u32, super::UDS_HEADER1>;
#[doc = "Register UDS_HEADER1 `reset()`'s with value 0"]
impl crate::ResetValue for super::UDS_HEADER1 {
    type Type = u32;
    #[inline(always)]
