#[doc = "Reader of register PRINCE_REGION0_HEADER1"]
pub type R = crate::R<u32, super::PRINCE_REGION0_HEADER1>;
#[doc = "Writer for register PRINCE_REGION0_HEADER1"]
pub type W = crate::W<u32, super::PRINCE_REGION0_HEADER1>;
#[doc = "Register PRINCE_REGION0_HEADER1 `reset()`'s with value 0"]
impl crate::ResetValue for super::PRINCE_REGION0_HEADER1 {
    type Type = u32;
    #[inline(always)]
